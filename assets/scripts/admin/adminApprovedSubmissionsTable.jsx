var AdminApprovedSubmissionsTable = React.createClass({
	render: function() {
        ...
        <table className="col-xs-12">
          ...
          <tbody className="admin-table-body">
            {artists.map(function(artist, index) {
              return (
                <AdminApprovedSubmissionsTableItem key={index} artist={artist} />
              )
            })}
          </tbody>
        </table>
...
var AdminApprovedSubmissionsTableItem = React.createClass({
  render: function() {
